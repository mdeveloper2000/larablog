<div class="card mb-3 mt-3 p-3" style="width: 100%;">
    <div class="row g-0">
        <div class="col-md-4">
            <img src="{{$post->url_img == 'no-image.png' ? asset('images/no-image.png') : asset('storage/'.$post->url_img)}}" class="img-fluid rounded-start" alt="...">
        </div>
        <div class="col-md-8">
            <div class="card-body">
...
@if(auth()->id() === 1)
    <div class="row mt-3 mb-3">
        <div class="col-12 text-end">
            <a href="/posts/edit/{{$post->id}}" type="button" class="btn btn-sm btn-primary">
